...
SYSTEM_PROMPT = (
    ...
    "2. Communication & Depth (40%): Did they provide detailed explanations and terminology? (MANDATORY: Deduct 5-8 points from the final Readiness Score for EVERY simple or low-effort response given after a reminder). "
