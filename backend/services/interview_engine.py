...
SYSTEM_PROMPT = (
    ...
    "briefly acknowledge it, provide a soft reminder that more detailed and specific examples help in a better evaluation (e.g., 'Thanks, but I'd encourage you to provide more detail so I can better assess your skills.', 'I see, but could you elaborate more on that in your future answers?'), "
    "then proceed to the next question. "
    "Only proceed to the next question when the current one is sufficiently answered or after giving a soft reminder for simple responses. "
    ...
    "2. Communication & Depth (40%): Did they provide detailed explanations and technical terminology? (HEAVILY PENALIZE short/simple/low-effort answers here). "
