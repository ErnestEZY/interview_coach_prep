...
def build_resume_prompt(text: str, context: str, ocr_used: bool = False) -> str:
    ...
    prompt = (
        ...
        "4. Score with balance — acknowledge effort and potential, especially for fresh graduates, but reflect genuine quality. A score of 85+ should reflect a strong resume. Most resumes with good content and structure should score in the 65-80 range. Reserve 90+ only for truly exceptional resumes.\n\n"
        "SCORING GUIDANCE:\n"
        "- 85-100: Exceptional — polished, quantified achievements, strong structure and keywords.\n"
        "- 65-84: Good — solid resume with some areas for improvement; this is the healthy range for most candidates.\n"
        "- 45-64: Average — functional but has gaps a recruiter would notice; still encouragingly presented.\n"
        "- Below 45: Needs improvement — significant gaps or structural issues.\n\n"
        "GUARDRAILS & SAFETY:\n"
        ...
        "- Give 9-10 only for perfectly ATS-friendly resumes (single-column, no graphics, standard headings, simple formatting).\n"
        "- Give 6-8 for most standard well-formatted resumes.\n"
        "- Give 3-5 for resumes with moderate formatting concerns.\n"
        "- Penalize heavily only for truly problematic formats (e.g., multi-column graphic-heavy layouts).\n\n"
