...
def build_resume_prompt(text: str, context: str, ocr_used: bool = False) -> str:
    ...
    prompt = (
        ...
        "Include a key 'Breakdown' with specific numeric values (0-30 for Technical and Communication, 0-20 for Alignment and Relevance) reflecting the scores for: "
    "'TechnicalScore', 'CommunicationScore', 'AlignmentScore', and 'RelevanceScore'. "
