...
// Global Startup Check: Just record the current startup_id.
// We no longer redirect or clear localStorage here — that was causing false
// logouts on every Render cold start (free tier spins down after inactivity).
// Invalid/expired tokens are handled naturally by the axios 401 interceptor
// which redirects to login on any API call that returns 401.
